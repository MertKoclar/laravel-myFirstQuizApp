        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('my')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Anasayfa</a>
                    <a href="{{route('quizzes.index')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Quiz</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item text-center">Tüm mesajları görüntüle</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <hr class="dropdown-divider">
                            <a href="#" class="dropdown-item text-center">Tüm bildirimleri görüntüle</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="/">Quizler</a>, All Right Reserved.
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            Designed By <a href="http://mertkoclar.com">mertkoclar</a>
                        </div>
                    </div>
                </div>
            </div>
